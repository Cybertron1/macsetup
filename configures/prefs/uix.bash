...
sudo scutil --set ComputerName "SIGABRT"
sudo scutil --set HostName "SIGABRT"
sudo scutil --set LocalHostName "SIGABRT"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "SIGABRT"
